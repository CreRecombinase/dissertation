...
cls1.counts=data.frame(dn=tada.data$dn.cls1, ca=tada.data$trans.cls1+tada.data$case.cls1, cn=tada.data$ntrans.cls1+tada.data$ctrl.cls1)
rownames(cls1.counts)=tada.data$gene.id
cls2.counts=data.frame(dn=tada.data$dn.cls2, ca=tada.data$trans.cls2+tada.data$case.cls2, cn=tada.data$ntrans.cls2+tada.data$ctrl.cls2)
...
# set up parameters
cls1= data.frame(gamma.mean.dn=20.0,beta.dn=1,gamma.mean.CC=2.3,beta.CC=4.0,rho1=0.1,nu1=100,rho0=0.1,nu0=100)
